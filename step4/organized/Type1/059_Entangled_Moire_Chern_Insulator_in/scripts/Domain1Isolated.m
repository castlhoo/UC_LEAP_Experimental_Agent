...
A = Plot_nSOT_Mag(11978, 35.5, 50000, 0); % Negative Field Training (point C)
B = Plot_nSOT_Mag(11963, 34.3, 200000, 0); % With domains (point D)
...
Diff.z = sqrt(2).*(Diff.z-mean(mean(Diff.z(end-100:end,1:20))));
...
%Plot the datasets
figure, Plot_nSOT_Mag(ASmooth); %This is Fig. 3 C
%Define the colormap
x = linspace(0,1,11);
...
figure, Plot_nSOT_Mag(BSmooth); %This is Fig. 3 D
%Define the colormap
x = linspace(0,1,11);
J = customcolormap(x, {'#68011D','#B5172F','#D75F4E','#F7A580','#FEDBC9','#F5F9F3','#D5E2F0','#93C5DC','#4295C1','#2265AD','#062E61'});
colorbar; colormap(J);
...
figure, Plot_nSOT_Mag(DiffSmooth); %This is Fig. 3 G
%Define the colormap
x = linspace(0,1,11);
J = customcolormap(x, {'#68011D','#B5172F','#D75F4E','#F7A580','#FEDBC9','#F5F9F3','#D5E2F0','#93C5DC','#4295C1','#2265AD','#062E61'});
colorbar; colormap(J);
...
figure, Plot_nSOT_Mag(MagSmooth); %This is Fig. 3 I 
%Define the colormap
