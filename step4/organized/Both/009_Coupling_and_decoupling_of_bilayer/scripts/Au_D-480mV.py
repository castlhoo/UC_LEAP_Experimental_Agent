...
bias1= np.genfromtxt(os.path.join(cwd,'Data','Au_D-480mVnm_bias.txt'), dtype= 'float', delimiter = '\n')


Delta_TG=np.genfromtxt(os.path.join(cwd,'Data','Au_D-480mVnm_topgate.txt'), dtype= 'float', delimiter = '\n')

Delta_BG=np.genfromtxt(os.path.join(cwd,'Data','Au_D-480mVnm_bottomgate.txt'), dtype= 'float', delimiter = '\n')


I_A1=1E-6*np.genfromtxt(os.path.join(cwd,'Data','Au_D-480mVnm_current.txt'), dtype= 'float')

# numerical calculation of dI/dV
...
plt.savefig(os.path.join(cwd,'Figures','AuPlot_480D_2.pdf'),  dpi=300,bbox_inches='tight' )