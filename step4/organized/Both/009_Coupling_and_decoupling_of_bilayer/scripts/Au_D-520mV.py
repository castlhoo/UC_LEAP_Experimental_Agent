...
bias1= np.genfromtxt(os.path.join(cwd,'Data','Au_D-520mVnm_bias.txt'), dtype= 'float', delimiter = '\n')


Delta_TG=np.genfromtxt(os.path.join(cwd,'Data','Au_D-520mVnm_topgate.txt'), dtype= 'float', delimiter = '\n')

Delta_BG=np.genfromtxt(os.path.join(cwd,'Data','Au_D-520mVnm_bottomgate.txt'), dtype= 'float', delimiter = '\n')


I_A1=1E-6*np.genfromtxt(os.path.join(cwd,'Data','Au_D-520mVnm_current.txt'), dtype= 'float')
