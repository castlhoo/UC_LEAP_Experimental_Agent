...
bias1= np.genfromtxt(os.path.join(cwd,'Data','Au_D-580mVnm_bias.txt'), dtype= 'float', delimiter = '\n')


Delta_TG=np.genfromtxt(os.path.join(cwd,'Data','Au_D-580mVnm_topgate.txt'), dtype= 'float', delimiter = '\n')

Delta_BG=np.genfromtxt(os.path.join(cwd,'Data','Au_D-580mVnm_bottomgate.txt'), dtype= 'float', delimiter = '\n')


I_A1=1E-6*np.genfromtxt(os.path.join(cwd,'Data','Au_D-580mVnm_current.txt'), dtype= 'float')
...
plt.savefig(os.path.join(cwd,'Figures','AuPlot_580D_2.pdf'),  dpi=300,bbox_inches='tight' )